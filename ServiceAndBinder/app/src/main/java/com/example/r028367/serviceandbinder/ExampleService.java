...
*/
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        * */
        ...
        Log.i(CATEGORY, text);
        /*
        * Caso o sistema encerre o Serviço por causa de falta de recurso
        * o mesmo não tentara reinicia-lo, a nao ser que ainda exista Intents
        * para entregar
        * */
        // int n = Service.START_NOT_STICKY;

        /*
        *
        * */
        // int n = Service.START_STICKY;
        // int n = Service.START_REDELIVER_INTENT
...
* */
    ...
    * */
    ...
    public void onCreate() {
        ...
        status = true;
        count = 0;
        (new Thread(this, "EXAMPLE_SERVICE")).start();
