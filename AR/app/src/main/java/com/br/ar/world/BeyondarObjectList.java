 ...
 * search is required
 */
public class BeyondarObjectList implements Iterable<com.beyondar.android.world.BeyondarObject> {
	...
	private ArrayList<com.beyondar.android.world.BeyondarObject> mContainer;
	private ArrayList<com.beyondar.android.world.BeyondarObject> mToRemoveQueue;

	private String mDefaultImageUri;

	private com.beyondar.android.world.World mWorld;

	private Object mLock;

	BeyondarObjectList(int type, com.beyondar.android.world.World world) {
		mType = type;
		mVisibility = true;
		mContainer = new ArrayList<com.beyondar.android.world.BeyondarObject>();
		mToRemoveQueue = new ArrayList<com.beyondar.android.world.BeyondarObject>();
		mWorld = world;
	 ...
	 * the {@link com.beyondar.android.world.World} instance
	 * 
	 * @param object
	 *            the object to add
	 ...
	 *         otherwise
	 */
	boolean add(com.beyondar.android.world.BeyondarObject object) {
	 ...
	 * @return
	 */
	public com.beyondar.android.world.BeyondarObject get(int index) {
	 ...
	 * @param object
	 */
	synchronized void remove(com.beyondar.android.world.BeyondarObject object) {
		synchronized (mLock) {
	 ...
	 * image is using the getDefaultBitmap(int) method in the {@link com.beyondar.android.world.World}
	 * instance.
	 * 
	 * @return
	 */
