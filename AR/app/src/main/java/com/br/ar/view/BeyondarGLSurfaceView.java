...
public class BeyondarGLSurfaceView extends GLSurfaceView implements OnBeyondarObjectRenderedListener {
	...
	private com.beyondar.android.view.BeyondarViewAdapter mViewAdapter;
	...
	public void setBeyondarViewAdapter(com.beyondar.android.view.BeyondarViewAdapter beyondarViewAdapter, ViewGroup parent) {
	...
	public void onBeyondarObjectsRendered(List<BeyondarObject> renderedBeyondarObjects) {
		com.beyondar.android.view.BeyondarViewAdapter tmpView = mViewAdapter;
		if (tmpView != null) {
