 ...
 */
package com.br.ar.util.location;
...
import com.beyondar.android.util.location.LocationUtils;
...
public class BeyondarLocationManager {
	...
	private static enum BeyondarLocationManagerSingleton {
		...
		private com.beyondar.android.util.location.BeyondarLocation mLocationListener;
		private BeyondarGpsListener mGpsListener;
		private boolean mIsEnabled;
		private boolean mGpsFix;

		private BeyondarLocationManagerSingleton() {
			mLocationListener = new com.beyondar.android.util.location.BeyondarLocation();
