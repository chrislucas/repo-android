 ...
 */
package com.br.ar.beyondar.util.location;
...
import com.beyondar.android.util.location.*;
...
class BeyondarLocation implements LocationListener {
	...
	void setLastKnowLocation(Location lastKnowLocation) {
		if (com.beyondar.android.util.location.LocationUtils.isBetterLocation(lastKnowLocation, mLastBestLocation)) {
	...
	public void onLocationChanged(Location location) {
		...
		if (!com.beyondar.android.util.location.LocationUtils.isBetterLocation(location, mLastBestLocation)) {
			return;
		}
