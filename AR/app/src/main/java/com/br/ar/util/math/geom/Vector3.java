 ...
 */
package com.br.ar.util.math.geom;
 ...
 * 
 */
public class Vector3 extends com.beyondar.android.util.math.geom.Point3 {
	 ...
	 */
	public Vector3(com.beyondar.android.util.math.geom.Point3 p1, com.beyondar.android.util.math.geom.Point3 p2) {
	 ...
	 * @param v
	 */
	public Vector3(com.beyondar.android.util.math.geom.Point3 v) {
		super(v);
	}
	 ...
	 */
	public static Vector3 normalVector(com.beyondar.android.util.math.geom.Point3 p1, com.beyondar.android.util.math.geom.Point3 p2, com.beyondar.android.util.math.geom.Point3 p3) {
	 ...
	 */
	public static Vector3 getVolatileVector(com.beyondar.android.util.math.geom.Point3 p1, com.beyondar.android.util.math.geom.Point3 p2) {
	 ...
	 *            end point
	 */
	public void set(com.beyondar.android.util.math.geom.Point3 p1, com.beyondar.android.util.math.geom.Point3 p2) {
		x = p2.x - p1.x;
		y = p2.y - p1.y;
		z = p2.z - p1.z;
		updateModule();
