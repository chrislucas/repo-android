...
import com.beyondar.android.util.cache.*;
...
public class BitmapCache {
	...
	private class BitmapCacheContainer extends com.beyondar.android.util.cache.LruCache<String, Bitmap> {
