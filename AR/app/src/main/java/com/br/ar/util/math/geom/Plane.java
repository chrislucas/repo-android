...
public class Plane {
	 ...
	 * Value returned must be used with {@link com.beyondar.android.util.math.geom.Ray#getPoint(float)}
	 * 
	 * @param ray
	 *            Ray to be checked
	 ...
	 */
	public float intersects(com.beyondar.android.util.math.geom.Ray ray) {
