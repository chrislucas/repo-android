...
import com.beyondar.android.util.*;
...
public class DebugBitmap {
	...
	public synchronized static void printReport() {
		com.beyondar.android.util.Logger.d("DebugBitmap", "++++++++++++++++++++++++++++++++++++++++++++");
		com.beyondar.android.util.Logger.d("DebugBitmap", "++++++++++++++++++++++++++++++++++++++++++++");
		com.beyondar.android.util.Logger.d("DebugBitmap", "++++++++++++++++++++++++++++++++++++++++++++");
		...
		while (keySet.hasNext()) {
			...
			com.beyondar.android.util.Logger.d("DebugBitmap", "URI:  " + string);
	...
	private static void printArrayList(ArrayList<Bitmap> arrayList,
		...
		if (arrayList == null || arrayList.size() == 0) {
			com.beyondar.android.util.Logger.d("DebugBitmap", "   No bitmaps");
		}
		int recycledCount = 0;
		int total = 0;
		for (Bitmap bitmap : arrayList) {
			...
			if (bitmap.isRecycled()) {
				...
				com.beyondar.android.util.Logger.d("DebugBitmap", "      Not recycled=" + bitmap.getWidth()
						+ "x" + bitmap.getHeight());
		...
		com.beyondar.android.util.Logger.d("DebugBitmap", "   " + recycledCount + "/" + total + " Recycled");
	}
}
