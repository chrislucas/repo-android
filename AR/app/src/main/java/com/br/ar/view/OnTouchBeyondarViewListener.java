...
public interface OnTouchBeyondarViewListener {
	...
	/**
	 * Use
	 * {@link com.beyondar.android.view.BeyondarGLSurfaceView#getBeyondarObjectsOnScreenCoordinates(float, float, java.util.ArrayList)}
	 ...
	 * @param beyondarView
	 */
	public void onTouchBeyondarView(MotionEvent event, com.beyondar.android.view.BeyondarGLSurfaceView beyondarView);
