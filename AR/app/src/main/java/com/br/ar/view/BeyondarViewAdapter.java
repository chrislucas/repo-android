		...
		mParentView.post(new Runnable() {
			...
			public void run() {
				for (BeyondarObject beyondarObject : list) {
					...
					com.beyondar.android.view.CustomLayout recycledParent = (com.beyondar.android.view.CustomLayout) mReusedViews.poll();
					...
					if (view != null && (recycledParent == null || view.getParent() != recycledParent)) {
						com.beyondar.android.view.CustomLayout parentLayout = new com.beyondar.android.view.CustomLayout(mContext);
